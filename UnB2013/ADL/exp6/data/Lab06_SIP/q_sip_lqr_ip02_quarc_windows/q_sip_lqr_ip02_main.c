...
typedef q_sip_lqr_ip02_rtModel RT_MODEL;

/*====================*
 * External functions *
 *====================*/
extern RT_MODEL * q_sip_lqr_ip02(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(q_sip_lqr_ip02_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://q_sip_lqr_ip02:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: q_sip_lqr_ip02 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
      ...
      if (result == 0) {
        result = hil_task_start
          (q_sip_lqr_ip02_DWork.EncoderInput0CartPositionEnco_p,
           q_sip_lqr_ip02_P.EncoderInput0CartPositionEncode, 1000.0, -1)
          ;
        if (result == 0) {
          ...
          /* disarm the timebase */
          hil_task_stop(q_sip_lqr_ip02_DWork.EncoderInput0CartPositionEnco_p)
            ;
